...
#ifndef EXCHANGE_LAKEBTC_H
#define EXCHANGE_LAKEBTC_H

#include "exchange.h"

class Exchange_LakeBTC : public Exchange
{
	Q_OBJECT

public:
	Exchange_LakeBTC(QByteArray pRestSign, QByteArray pRestKey);
	~Exchange_LakeBTC();
