...
#ifndef EXCHANGE_ZAIF_H
#define EXCHANGE_ZAIF_H

#include "exchange.h"

class Exchange_Zaif : public Exchange
{
	Q_OBJECT

public:
	void filterAvailableUSDAmountValue(double *amount);
	Exchange_Zaif(QByteArray pRestSign, QByteArray pRestKey);
	~Exchange_Zaif();
